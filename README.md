...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/supply--chain-procurement-orange.svg" alt="Topic">
  <img src="https://img.shields.io/badge/status-production--ready-brightgreen.svg" alt="Status">
</p>


*Evaluating and selecting suppliers using multi-criteria decision frameworks*

---

## 📋 Overview

**Order Splitting Optimizer** addresses a critical challenge in modern supply chain management: sourcing. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.

Built on the foundational work of **Professor Jayashankar Swaminathan**, this tool provides supply chain professionals with an analytical framework that transforms raw operational data into actionable optimization decisions. Whether you're managing a single warehouse or a global multi-echelon network, this toolkit scales to your complexity.
...
Supply chain sourcing is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize sourcing typically see:
...
```bash
git clone https://github.com/virbahu/order-splitting-optimizer.git
cd order-splitting-optimizer
pip install -r requirements.txt
python order_splitting_optimizer.py
```
...
```python
# Quick start example
from order_splitting_optimizer import *
...
# See docstrings in order_splitting_optimizer.py for full parameter reference
```
...
| | |
|---|---|
| **Based on** | Professor Jayashankar Swaminathan, UNC Kenan-Flagler |
| **Key Reference** | See academic references for Professor Jayashankar Swaminathan |
| **Domain** | Sourcing |
